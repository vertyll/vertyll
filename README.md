...
| [FastDo](https://github.com/vertyll/fastdo) `EN` `PL` ![Static Badge](https://img.shields.io/badge/LP-green) | [Rust console projects](https://github.com/vertyll/rust-console-projects) `EN` | - |
| [Festival Page](https://github.com/vertyll/festival-page) `PL` ![Static Badge](https://img.shields.io/badge/LP-green) | [Multithreaded Web Server](https://github.com/vertyll/multithreaded-web-server) `EN` | - |
| [Festival Admin](https://github.com/vertyll/festival-admin) `PL` ![Static Badge](https://img.shields.io/badge/LP-green) | - | - |
| [SnapTale](https://github.com/vertyll/SnapTale) `PL` ![Static Badge](https://img.shields.io/badge/LP-green) | - | - |
